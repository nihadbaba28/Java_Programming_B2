...
public class OverTime {
    ...
    public static void main(String[]  args) {
        ...
        double numberOfHours = 42;
        double netPay = hourlyRate * numberOfHours;
        double overTimeHours = numberOfHours - 40;
        /*
        if numOfHours > 40
        overTimeHours = numberOfHours - 40;
         netPay = (hourlyRate * 40) + (overTimeHours * hourlyRate * 1.5)
         message = You worked 42 hours at a rate of $60, but 2 of the hours were overtime
         */
        if ( numberOfHours > 40) {
            netPay = hourlyRate * 40 + (overTimeHours * hourlyRate * 1.5);
          String message = "You worked  " + numberOfHours + " hours at a rate of " + hourlyRate + " but " + overTimeHours + " of overtime, so you got an $" + netPay;

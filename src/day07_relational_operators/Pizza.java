...
public class Pizza {
     ...
     */
     public static void main(String[] args) {
         ...
         String report = "We ordered " + typeOfPizza + " pizza with the " +numOfSlices + " slices. " + numOfPeople + " people ate " + slicesLeftOver + " for eac. There were " + slicesLeftOver + " slice left";
